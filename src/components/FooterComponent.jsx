      ...
      <div className="container mx-auto px-4">
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {tabs.find((tab) => tab.key === activeTab).items.map((item, index) => (
              <div key={index} className="flex flex-col">
                <a href="#" className="text-black font-bold">{item.place}</a>
        ...
        <div className="border-t border-gray-300 pt-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 hover:text-black">도움말 센터</a></li>
                <li><a href="#" className="text-gray-600 hover:text-black">에어커버</a></li>
                <li><a href="#" className="text-gray-600 hover:text-black">차별 반대</a></li>
                <li><a href="#" className="text-gray-600 hover:text-black">장애인 지원</a></li>
                {/* TODO : 링크 추가 필요 */}
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 hover:text-black">당신의 공간을 에어비앤비하세요</a></li>
                <li><a href="#" className="text-gray-600 hover:text-black">호스트를 위한 에어커버</a></li>
                <li><a href="#" className="text-gray-600 hover:text-black">호스팅 자료</a></li>
                <li><a href="#" className="text-gray-600 hover:text-black">커뮤니티 포럼</a></li>
                {/* TODO : 링크 추가 필요 */}
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 hover:text-black">뉴스룸</a></li>
                <li><a href="#" className="text-gray-600 hover:text-black">새로운 기능</a></li>
                <li><a href="#" className="text-gray-600 hover:text-black">채용 정보</a></li>
                <li><a href="#" className="text-gray-600 hover:text-black">투자자 정보</a></li>
                {/* TODO : 링크 추가 필요 */}
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-300 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-600 text-sm">&copy; 2024 Airbnb, Inc. 모든 권리 보유. 개인 정보 처리 방침 | 이용약관 | 사이트맵 | 한국의 변경된 환불 정책 | 회사 세부정보</p>
              <div className="flex space-x-4 mt-4 md:mt-0">
                ...
                <a href="#"><img src={linkedinIcon} alt="LinkedIn" className="h-6" /></a>
              </div>
            </div>
          </div>
        </div>
